  ...
  <div class="container">
    ...
    <van-grid :column-num="3">
      <van-grid-item
        ...
        :key="index"
        @click="$router.push({ name: item.url, query: { store_id: store_id } })"
      >
...
export default {
  ...
  data() {
    return {
      ...
      gridlist: [
        ...
        // {
        //   text: "增值服务",
        //   src: require("../../assets/bg/8.png"),
        //   url: "ClassifiedManagement"
        // },
        // {
        //   text: "操作指南",
        //   src: require("../../assets/bg/9.png"),
        //   url: "ClassifiedManagement"
        // }
      ]
    };
  ...
  async created() {
    ...
    try {
      ...
      const response = await BackStagemanagement.homeStore(data);
      window.console.log(response.data);
      if (response.data.err_code == 0) {
