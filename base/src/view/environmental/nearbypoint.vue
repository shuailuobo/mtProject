<template>
  <div class="container">
    ...
    <div class="allnums">
      <p>共找到“附近回收点”相关{{ areaslists.length }}个结果</p>
    </div>
    <div class="areasbox">
    ...
    <!-- <van-action-sheet v-model="show" title="请选择" safe-area-inset-bottom>
      <div>
        <a class="mapurl" :href="getGaodeHref()">高德地图</a>
      </div>
      <div>
        <a class="mapurl" :href="getBaiduHref()">百度地图</a>
      </div>
    </van-action-sheet> -->
  </div>
</template>
  ...
  data() {
    return {
      ...
      areaslists: [
        // {
        //   id: "1",
        //   src: require("../../assets/environmental/distance_map@2x.png"),
        //   name: "健康路回收点",
        //   details: "南京市秦淮区白鹿村白鹭洲公园门口",
        //   distance: "58",
        //   lng: "118.795943",
        //   lat: "32.026232",
        //   show: false
