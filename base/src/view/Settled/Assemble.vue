<template>
  <div class="container">
    ...
    <div>
      ...
      <div class="explain">
        <p>
          提交申请前请务必仔细阅读拼团入驻说明和协议，内附增值收入和操作说明。
        </p>
      </div>
    </div>
  </div>
  ...
  methods: {
    async submit() {
      ...
      let data = {
        ...
        phone: this.phone,
        wechat: this.wechat,
        biz_cert: this.biz_license,
        id_card_pic: this.personal_license.join(",")
      };
    ...
    ChooseCoverImage: function() {
      ...
      var syncUpload = function(localIds) {
        ...
        that.license = localId;
        wx.uploadImage({
          localId: localId,
          isShowProgressTips: 1,
          success: function(res) {
            that.biz_license = res.serverId;
          }
        });
      };
    },
    ChoosePersonalLicense: function() {
      var that = this;
      var i = 0;
      var imgArr = [];
      var localIdArr = [];
